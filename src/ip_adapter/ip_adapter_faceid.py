...
if is_torch2_available() and (not USE_DAFAULT_ATTN):
    from .attention_processor_faceid import LoRAAttnProcessor2_0 as LoRAAttnProcessor
    from .attention_processor_faceid import LoRAIPAttnProcessor2_0 as LoRAIPAttnProcessor
else:
    from .attention_processor_faceid import LoRAAttnProcessor, LoRAIPAttnProcessor
