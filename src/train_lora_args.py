...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="The name of the local dataset to train on (e.g., affectnet, celeba_hq, fetext, ffhq, raf_db, sfew, custom_combined).",
    )
    parser.add_argument(
        "--train_data_dir",
        type=str,
        default=None,
        help="A folder containing the local training datasets.",
    )
    parser.add_argument(
        "--dataset_split",
        type=str,
        ...
        help="The split of the dataset to use for training (e.g., train, test, val, both).",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Weights & Biases token for logging training metrics",
    )
