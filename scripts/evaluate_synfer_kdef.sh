...
LOG_FILE="${OUT_DIR}/eva_synfer_kdef_${JOB_ID}.log"
ERR_FILE="${OUT_DIR}/eva_synfer_kdef_${JOB_ID}.err"
...
PYTHONPATH=.:src:OpenGraphAU:POSTER_V2 uv run accelerate launch \
    ...
    --ref_dataset_dir datasets/kdef \
    --output_dir outputs/synthetic_kdef \
