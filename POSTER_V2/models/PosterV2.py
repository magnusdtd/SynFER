...
class pyramid_trans_expr2(nn.Module):
    def __init__(
        ...
        face_landback_checkpoint = torch.load(
            r"./outputs/pretrain_models/mobilefacenet_model_best.pth.tar", map_location=lambda storage, loc: storage
        )
        ...
        ir_checkpoint = torch.load(r"./outputs/pretrain_models/ir50.pth", map_location=lambda storage, loc: storage)
